...
const L3D1: TutorialStep[] = [
  ...
  {
    id: 'L3D1-2',
    bubble: { type: 'dialogue', text: 'Start with \ud83c\udf4c Banana \u2014 it costs 1 WP.', expression: 'neutral' },
    highlight: ['food:banana', 'slot:2'],
    highlightType: 'pulse',
    cta: { type: 'drag-arrow', source: 'food:banana', dest: 'slot:2' },
    advanceOn: 'action',
    expectedAction: { type: 'place-food', foodId: 'banana' },
  },
  {
    id: 'L3D1-3',
    bubble: { type: 'dialogue', text: 'Now drag \ud83c\udf4e Apple \u2014 also 1 WP.', expression: 'neutral' },
    highlight: ['food:apple', 'slot:3'],
    highlightType: 'pulse',
    cta: { type: 'drag-arrow', source: 'food:apple', dest: 'slot:3' },
    advanceOn: 'action',
    expectedAction: { type: 'place-food', foodId: 'apple' },
  },
  {
    id: 'L3D1-4',
  ...
  {
    id: 'L3D1-7',
    bubble: { type: 'dialogue', text: 'Place \ud83e\udd5b Milk and submit!', expression: 'happy', position: 'inventory' },
    highlight: 'food:milk',
    highlightType: 'pulse',
