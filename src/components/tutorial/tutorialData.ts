...
const L1D1: TutorialStep[] = [
  {
    id: 'L1D1-1',
    bubble: { type: 'dialogue', text: "Welcome to BG Planner! I'm Doctor Alice, and I'll teach you how to manage blood glucose.", expression: 'happy', position: 'center' },
    advanceOn: 'tap',
    blockInteraction: true,
  },
  {
    id: 'L1D1-2',
    bubble: { type: 'dialogue', text: 'This is the BG Graph. The Y-axis shows blood glucose levels. Green zone (60\u2013140) is safe. Yellow (140\u2013200) is elevated. Orange and red are dangerous!', expression: 'neutral' },
    highlight: 'graph',
...
const L1D3: TutorialStep[] = [
  ...
  {
    id: 'L1D3-3',
    bubble: { type: 'dialogue', text: 'Look at the amber bars on the graph \u2014 insulin is stronger in the morning (rate 3) and weaker in the evening (rate 1). Place food where insulin is high!', expression: 'thinking' },
...
const L2D3: TutorialStep[] = [
  ...
  {
    id: 'L2D3-2',
    bubble: { type: 'dialogue', text: 'You have both a walk AND a run today. Use them wisely to control the muffin peak!', expression: 'thinking' },
    advanceOn: 'tap',
  },
  {
    id: 'L2D3-3',
...
const L3D1: TutorialStep[] = [
  ...
  {
    id: 'L3D1-2',
    bubble: { type: 'dialogue', text: 'New tool: \u2615 Take a Break! It costs \u22121 WP \u2014 meaning it REFUNDS 1 WP. Use it to stretch your budget!', expression: 'happy' },
    highlight: 'intervention-inventory',
    highlightType: 'spotlight',
    advanceOn: 'tap',
    blockInteraction: true,
