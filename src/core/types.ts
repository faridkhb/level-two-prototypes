...
export const PANCREAS_TIERS: Record<PancreasTier, { rate: number; cost: number; label: string }> = {
  0: { rate: 0, cost: 0, label: 'OFF' },
  1: { rate: 0.25, cost: 0, label: 'I' },
  2: { rate: 0.5, cost: 1, label: 'II' },
  3: { rate: 0.75, cost: 2, label: 'III' },
};
